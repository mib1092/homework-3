...
<head>
    ...
    <link rel="stylesheet" href="<? bloginfo('template_url'); ?>/css/flipclock.css">

    <script type="text/javascript" src="<? bloginfo('template_url'); ?>/js/jquery-1.6.4.min.js"></script>
    <script src="<? bloginfo('template_url'); ?>/js/libs/prefixfree.min.js"></script>
<!--    <script type="text/javascript" src="--><?// bloginfo('template_url'); ?><!--/js/flipclock.min.js"></script>-->
...
<div id="wrap">
    <div id="header">
        <h1><a href="index.html">GeekHub</a></h1>
        <ul class="nav">
